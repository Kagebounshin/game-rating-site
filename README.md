...
- Profile 
    ...
    - To make your review complete, you'll add an [images](img-readme/profile23.png). But because of a bug at the edit review page, I removed the choice to change your image, so be sure to add the images you really want. Added a [warning](img-readme/profile28.png) text below the image input field.
...
-   [W3C CSS Validator](https://jigsaw.w3.org/css-validator/#validate_by_input) 
    -   [No Error Found](img-readme/cssValidation.png)
    -   [Warnings](img-readme/cssWarning.png)

- [PEP8 Online](http://pep8online.com/) - Validation for Python Code
    - [Results](img-readme/pep8.png)

- [JSHint](https://jshint.com/) - Validation for JavaScript code. 
    - [Results](img-readme/jshint.png)
### Lighthouse Testing
